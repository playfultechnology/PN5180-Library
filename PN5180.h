...
#define WRITE_REGISTER_MULTIPLE 		(0x03)
#define PN5180_READ_REGISTER            (0x04)
#define READ_REGISTER_MULTIPLE			(0x05)
...
#define MIFARE_AUTHENTICATE 			(0x0C)
#define EPC_INVENTORY 					(0x0D) 
#define EPC_RESUME_INVENTORY 			(0x0E)
#define EPC_RETRIEVE_INVENTORY_RESULT_SIZE (0x0F)
#define EPC_RETRIEVE_INVENTORY_RESULT 	(0x10)
#define PN5180_LOAD_RF_CONFIG           (0x11)
#define UPDATE_RF_CONFIG 				(0x12)
#define RETRIEVE_RF_CONFIG_SIZE 		(0x13)
#define RETRIEVE_RF_CONFIG 				(0x14)
